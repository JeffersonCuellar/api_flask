...
# #COPS
# user = os.environ['ORACLE_USER_COPS']
# password = os.environ['ORACLE_PASSWORD_COPS']
# host = os.environ['ORACLE_HOST_COPS']
# port = os.environ['ORACLE_PORT_COPS']
# server_name = os.environ['ORACLE_SERVER_NAME_COPS']
